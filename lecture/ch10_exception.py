...
#  '-' 없이 전화번호를 입력하세요. 
# 사용자 1: 111- 11-11 -ㄷㄷㄷ
# 사용자 2: 010-1234-1234 -> 정규식
# 개발자가 의도한 값 : 01012341234
...
#     print("자원해제")
try:
    html = urlopen("http://www.naver.com1233123")
except:
    print("올바른 URL을 입력하세요.")            # 예외처리
else:
    print("No Error")
finally:
    print("자원해제")
...
#  ** 개발자 취업
#  1. SI(시스템 통합)
#    - 사업을 수주하고 사업 관련 프로그램을 개발
#    - 회사 자체 프로그램 개발 X
#      하드웨어 + 소프트웨어

#  2. 솔루션
#    - 회사 자체 프로그램(당근, 한글과컴퓨터 등등)
